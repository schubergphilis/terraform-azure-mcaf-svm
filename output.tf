...
output "subscription_id" {
  value = data.azapi_resource.example.output.properties.subscriptionId
  description = "subscription id"
}

output "display_name" {
  value = data.azapi_resource.example.output.name
  description = "subscription display name"
}

output "id" {
  value = "/subscriptions/${data.azapi_resource.example.output.properties.subscriptionId}"
